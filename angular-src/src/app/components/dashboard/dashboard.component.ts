    ...
    this.authService.getProducts().subscribe(data => {
      ...
      for (let product of this.products) {
        if (product.Catag == "ring") {
          // 1, "string", false
          product.img="../../../assets/data/rings/"+product.img;
          this.rings.push(product);
        }
        else if (product.Catag == "neck") {
          product.img="../../../assets/data/neck/"+product.img;
          ...
          product.img="../../../assets/data/pen/"+product.img;
          this.pens.push(product);
        }
        else if (product.Catag == "ear") {
          product.img="../../../assets/data/earing/"+product.img;
